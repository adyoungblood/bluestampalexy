...
void loop()
{
  ...
  yours accordingly. */
  int pos1 = map(flex1, 400, 600, 180, 0);
  pos1 = constrain(pos1, 0, 180);
  int pos2 = map(flex2, 500, 700, 180, 0);
  pos2 = constrain(pos2, 0, 180);
  int pos3 = map(flex3, 300, 610, 180, 0);
  pos3 = constrain(pos3, 0, 180);
  int pos4 = map(flex4, 400, 675, 180, 0);
  pos4 = constrain(pos4, 0, 180);
  //int pos5 = map(flex5, 400, 700, 180, 0);
